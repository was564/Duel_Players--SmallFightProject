...
{
    public class MultiNormalPlayingRoundInitialize : PlayersInitializeInRoundFactory
    {
        public MultiNormalPlayingRoundInitialize(Dictionary<PlayerCharacter.CharacterIndex, PlayerCharacter> players)
            : base(players) {}
